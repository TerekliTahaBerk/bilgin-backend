...
final class CurriculumMapController extends AdminController
{
     ...
     * verisinden gelir ve ortamdan ortama değişir. Panele sabit kimlik
    ...
    public function options(): JsonResponse
    {
        ...
        // Panel oturumları varyantın exam_id'sine göre süzüyor; bu yüzden
        // exam_id her satırda zorunlu.
